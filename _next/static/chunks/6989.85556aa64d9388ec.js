  ...
  [6989],
  {
    546: (t, i, e) => {
      var l = e(28312),
        a = e(745),
        o = e(51882);
      e(23499), e(25322), e(4537), e(98750), e(43804);
      var r = e(97265),
        h = e(54166);
      e(89556);
      let s = (0, l.AH)`
        ...
        var a,
          ...
          r =
            o < 3
              ? i
              : null === l
              ? (l = Object.getOwnPropertyDescriptor(i, e))
              : l;
    ...
    `;
        ...
        visualTemplate() {
          if ("image" === this.variant && this.imageSrc)
            return (0, l.qy)`<wui-image src=${this.imageSrc} alt=${
              this.alt ?? "list item"
            }></wui-image>`;
          if (
      ...
      ></wui-loading-spinner>`
        ...
        chevronTemplate() {
          return this.chevron
            ? (0,
              l.qy)`<wui-icon size="inherit" color="fg-200" name="chevronRight"></wui-icon>`
            : null;
        }
      };
...
`,
  ...
  <defs>
    <clipPath id="a"><path fill="#fff" d="M0 0h60v60H0z" /></clipPath>
        ...
        u = (0,
        l.JW)`<svg width="40" height="42" viewBox="0 0 40 42" fill="none">
...
`,
  ...
  <rect width="59" height="59" x=".5" y=".5" stroke="#fff" stroke-opacity=".1" rx="2.5" />
        ...
        y = (0,
        l.JW)`<svg width="60" height="60" viewBox="0 0 60 60" fill="none">

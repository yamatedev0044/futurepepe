(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [2414],
  {
              ...
              for (let r of n[e]) {
                ...
                if (void 0 !== e)
                  if ("bytes" === r.type)
                    ...
                    o.push("bytes32"),
                      (e = i.keccak(this.encodeData(r.type, e, n, a))),
                      c.push(e);
    ...
    22414: (e, t, n) => {
      "use strict";
      n.d(t, { createCoinbaseWalletSDK: () => tr });
      class s {
        constructor(e, t) {
      ...
      class X {
        ...
        async loadKeysIfNeeded() {
          null === this.ownPrivateKey &&
            (this.ownPrivateKey = await this.loadKey(V)),
      ...
      class eo {
        constructor(e) {
          ...
          (this.metadata = e.metadata),
            ...
            (this.accounts =
              null != (t = this.storage.loadObject(es)) ? t : []),
            (this.chain = this.storage.loadObject(ei) || {
              id:
                null !=
                (i = null == (n = e.metadata.appChainIds) ? void 0 : n[0])
                  ? i
                  : 1,
            }),
        ...
        async decryptResponseMessage(e) {
          ...
          let r = await Y(s.encrypted, i),
            a = null == (t = r.data) ? void 0 : t.chains;
          if (a) {
          ...
          let o = null == (n = r.data) ? void 0 : n.capabilities;
          ...
          return (
            ...
            (i !== this.chain &&
              ...
              null == (n = this.callback) ||
                n.call(this, "chainChanged", L(i.id))),
            !0)
          );
        }
      }
      ...
      class ef {
        constructor({ session: e, linkAPIUrl: t, listener: n }) {
          (this.destroyed = !1),
            ...
            (this.handleChainUpdated = async (e, t) => {
              ...
              null == (n = this.listener) || n.chainUpdated(s, i);
            }),
            (this.session = e),
            (this.cipher = new ed(e.secret)),
            (this.listener = n);
          let s = new ep(`${t}/rpc`, WebSocket);
        ...
        async handleIncomingEvent(e) {
          ...
          null == (t = this.listener) || t.handleWeb3ResponseMessage(s, i);
        }
      ...
      class eC extends eE {
        ...
        digestInto(e) {
          ...
          this.finished = !0;
          let { buffer: n, view: s, blockLen: i, isLE: r } = this,
            { pos: a } = this;
          (n[a++] = 128),
            e_(this.buffer.subarray(a)),
            this.padOffset > i - a && (this.process(s, 0), (a = 0));
          for (let e = a; e < i; e++) n[e] = 0;
          !(function (e, t, n, s) {
          ...
          for (let e = 0; e < l; e++) o.setUint32(4 * e, u[e], r);
        }
        digest() {
      ...
      class eN extends eC {
        ...
        process(e, t) {
          for (let n = 0; n < 16; n++, t += 4) eL[n] = e.getUint32(t, !1);
          for (let e = 16; e < 64; e++) {
            let t = eL[e - 15],
              n = eL[e - 2],
              s = ew(t, 7) ^ ew(t, 18) ^ (t >>> 3),
              i = ew(n, 17) ^ ew(n, 19) ^ (n >>> 10);
            eL[e] = (i + eL[e - 7] + s + eL[e - 16]) | 0;
          }
      ...
      !(function (e, t = !1) {
        ...
        for (let r = 0; r < n; r++) {
          let { h: n, l: a } = (function (e, t = !1) {
            return t
              ? { h: Number(e & eM), l: Number((e >> eA) & eM) }
              : { h: 0 | Number((e >> eA) & eM), l: 0 | Number(e & eM) };
          })(e[r], t);
          [s[r], i[r]] = [n, a];
        }
      })(
      ...
      class eU {
        ...
        static load(e) {
          let t = e.getItem(eR),
            n = e.getItem(ej),
            s = e.getItem(eT);
          return t && s ? new eU(e, t, s, "1" === n) : null;
        }
        get linked() {
          return this._linked;
        }
        ...
        persistLinked() {
          this.storage.setItem(ej, this._linked ? "1" : "0");
        }
      }
      function eO() {
        var e, t;
              ...
              (0, ez.h)(
                ...
                (0, ez.h)(
                  ...
                  Array.from(this.items.entries()).map(([e, t]) =>
                    (0, ez.h)(eF, Object.assign({}, t, { key: e }))
                  )
                )
              ),
              this.root
      ...
      let eB = (e) =>
          (0, ez.h)(
            "div",
            { class: (0, eq.clsx)("-cbwsdk-snackbar-container") },
            (0, ez.h)(
              "style",
              null,
            ...
            (0, ez.h)("div", { class: "-cbwsdk-snackbar" }, e.children)
          ),
        eF = ({ autoExpand: e, message: t, menuItems: n }) => {
          let [s, i] = (0, eK.useState)(!0),
            [r, a] = (0, eK.useState)(null != e && e);
          return (
            (0, eK.useEffect)(() => {
              let e = [
                window.setTimeout(() => {
      ...
      class e$ {
        constructor() {
          (this.root = null), (this.darkMode = eO());
        }
        attach() {
          let e = document.documentElement;
          (this.root = document.createElement("div")),
      ...
      class eQ {
        ...
        subscribe() {
          let e = eU.load(this.storage) || eU.create(this.storage),
            ...
            s = this.isMobileWeb ? new eV() : new eG();
          ...
          return new Promise((i, r) => {
            (t = this.ui.showConnecting({
              ...
              this.relayEventManager.callbacks.set(n, (e) => {
                if ((null == t || t(), eu(e))) return r(Error(e.errorMessage));
                i(e);
              }),
        ...
        requestEthereumAccounts() {
          ...
          return new Promise((e, t) => {
            this.relayEventManager.callbacks.set(s, (n) => {
              ...
              eQ.accountRequestCallbackIds.add(s),
      ...
      class e1 {
        constructor(e) {
          (this._relay = null),
            (this._addresses = []),
            (this.metadata = e.metadata),
            (this._storage = new s("walletlink", eY)),
        ...
        get jsonRpcUrl() {
          var e;
          return null != (e = this._storage.getItem(e0)) ? e : void 0;
        }
        set jsonRpcUrl(e) {
        ...
        async addEthereumChain(e) {
          ...
          let r = this.initializeRelay(),
            ...
            h = await r.addEthereumChain(i.toString(), a, l, o, c, u);
          if (eu(h)) return !1;
        ...
        _setAddresses(e, t) {
          ...
          JSON.stringify(s) !== JSON.stringify(this._addresses) &&
            ...
            this._storage.setItem(el, s.join(" ")));
        }
        async request(e) {
          let t = e.params || [];
          switch (e.method) {
        ...
        _prepareTransactionParams(e) {
          ...
          let n = e.to ? U(e.to) : null,
            s = null != e.value ? q(e.value) : BigInt(0),
            i = e.data ? O(e.data) : eZ.alloc(0),
        ...
        getChainId() {
          ...
          return Number.parseInt(
            null != (e = this._storage.getItem(eX)) ? e : "1",
            10
          );
        }
      ...
      let e2 = "SignerType",
        e3 = new s("CBWSDK", "SignerConfigurator");
      async function e5(e) {
        let {
          communicator: t,
          metadata: n,
      ...
      async function e4(e, t, n) {
        ...
        let s = new e1({ metadata: t, callback: n });
        e.postMessage({
...
Please see https://www.smartwallet.dev/guides/tips/popup-tips#cross-origin-opener-policy for more information.`,
      ...
      class ts extends tt {
        ...
        initSigner(e) {
          ...
          switch (t) {
            case "scw":
              return new eo({ metadata: n, callback: i, communicator: s });
            case "walletlink":
      ...
      let ti = { options: "all" };
      function tr(e) {
        new s("CBWSDK").setItem("VERSION", ee), e6();
        let t = {
          metadata: {
          ...
          preference: Object.assign(ti, null != (n = e.preference) ? n : {}),
        };
        var n,
          i = t.preference;
        if (i) {
          ...
          if (
            i.attribution &&
            void 0 !== i.attribution.auto &&
            void 0 !== i.attribution.dataSuffix
          )
            throw Error(
                ...
                return null !=
                  (t = (function ({ metadata: e, preference: t }) {
                    ...
                    if ("smartWalletOnly" !== t.options) {
                      ...
                      if (e)
                        return (
                          null == (n = e.setAppInfo) || n.call(e, i, r, a, t), e
                        );
                    }
                    let o = (function () {
                      var e, t;
                    ...
                    if (null == o ? void 0 : o.isCoinbaseBrowser)
                      return (
                        null == (s = o.setAppInfo) || s.call(o, i, r, a, t), o
                      );
                  })(n))
                  ? t
                  : new ts(n);
        ...
        (u.__r = function (e) {
          ...
          t &&
            (r === i
              ...
              : (t.__h.forEach(N), t.__h.forEach(D), (t.__h = []), (s = 0))),
            (r = i);
        }),
        (u.diffed = function (e) {
          p && p(e);
      ...
      function u(e, t) {
        ...
        if ((p = e).lastIndexOf("]") === p.length - 1) {
          ...
          return (
            ...
            t.length % 32 != 0 &&
              (d = s.concat([d, i.zeros(32 - (t.length % 32))])),
            d
          );
    ...
    66117: (e, t, n) => {
      ...
      function k(e, t, n) {
        var i,
          ...
          o = {};
        for (a in t)
          "key" == a ? (i = t[a]) : "ref" == a ? (r = t[a]) : (o[a] = t[a]);
        if (
          (arguments.length > 2 &&
      ...
      function A() {
        for (var e, t, n, s, r, a, c = 1; o.length; )
          o.length > c && o.sort(u),
            (e = o.shift()),
            (c = o.length),
            e.__d &&
      ...
      function P(e, t, n, s, r, a, o, c, l, u, d) {
        var h,
          p,
          f,
          g,
        ...
        for (
                  ...
                  (function e(t, n, s) {
                    ...
                    if ((r = t.__k))
                      for (a = 0; a < r.length; a++)
                        r[a] && e(r[a], n, s || "function" != typeof t.type);
                    s || v(t.__e), (t.__c = t.__ = t.__e = void 0);
                  })(c, c));
            return s;
          })(n, t, k, l, I),
            h = 0;
          ...
          null != (f = n.__k[h]) &&
            ...
            f.ref &&
              p.ref != f.ref &&
              (p.ref && j(p.ref, null, f), d.push(f.ref, f.__c || g, f)),
            null == _ && null != g && (_ = g),
            4 & f.__u || p.__k === f.__k
              ? (l = (function e(t, n, s) {
                  var i, r;
        ...
        e: if ("function" == typeof W)
          try {
            if (
              ...
              (M = (h = W.contextType) && r[h.__c]),
              (A = h ? (M ? M.props.value : h.__) : r),
              n.__c
            ...
            (p.state = p.__s),
              ...
              I &&
                ...
                (_ = p.getSnapshotBeforeUpdate(g, b)),
              (j = h),
              null != h &&
                h.type === E &&
                null == h.key &&
              ...
              (l = P(e, y(j) ? j : [j], t, n, r, a, o, c, l, u, d)),
              (p.base = t.__e),
              (t.__u &= -161),
      ...
      function T(e, t, n) {
        for (var s = 0; s < n.length; s++) j(n[s], n[++s], n[++s]);
        i.__c && i.__c(t, e),
          e.some(function (t) {
            try {
              (e = t.__h),
      ...
      function q(e, t, n) {
        ...
        return (
          arguments.length > 2 &&
            (c.children = arguments.length > 3 ? s.call(arguments, 2) : n),
          x(e.type, c, i || e.key, r || e.ref, null)
        );
      }
      function z(e) {
        function t(e) {
    ...
    67676: (e, t, n) => {
      ...
      n.r(t), n.d(t, { clsx: () => s, default: () => i });
      let i = s;
    },
    96236: (e, t, n) => {
      var s = n(44134).Buffer;
      let { keccak_256: i } = n(91034);
      function r(e) {

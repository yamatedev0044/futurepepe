          ...
          return (
            ...
            Object.entries(p)
              ...
              .forEach(([t, e]) => {
                e.forEach((e) => {
                  s.push(
                    (0, n.JW)`<circle cx=${t} cy=${e} fill=${o} r=${u / 2.5} />`
                  );
                });
              }),
            Object.entries(p)
...
`;
    ...
    `),
            (0, n.qy)`${this.templateVisual()} ${this.templateSvg()}`
          );
        }
        templateSvg() {
    ...
    `;
        ...
        templateVisual() {
          return this.imageSrc
            ? (0, n.qy)`<wui-image src=${this.imageSrc} alt=${
                this.alt ?? "logo"
              }></wui-image>`
            : this.farcaster
            ? (0, n.qy)`<wui-icon
      ...
      ></wui-icon>`
            : (0,
              n.qy)`<wui-icon size="inherit" color="inherit" name="walletConnect"></wui-icon>`;
        }
      };
      (f.styles = [l.W5, h]),
        c([(0, o.MZ)()], f.prototype, "uri", void 0),
        c([(0, o.MZ)({ type: Number })], f.prototype, "size", void 0),
        c([(0, o.MZ)()], f.prototype, "theme", void 0),
        c([(0, o.MZ)()], f.prototype, "imageSrc", void 0),
        c([(0, o.MZ)()], f.prototype, "alt", void 0),
        c([(0, o.MZ)()], f.prototype, "color", void 0),
        c([(0, o.MZ)({ type: Boolean })], f.prototype, "arenaClear", void 0),
        c([(0, o.MZ)({ type: Boolean })], f.prototype, "farcaster", void 0),
        (f = c([(0, u.E)("wui-qr-code")], f));
    },
    8527: (t, e) => {
      function r(t) {
...
`;
      ...
      (u.styles = [i.W5, i.ck, s]),
        l([(0, o.MZ)()], u.prototype, "src", void 0),
        l([(0, o.MZ)()], u.prototype, "alt", void 0),
        l([(0, o.MZ)()], u.prototype, "size", void 0),
        (u = l([(0, a.E)("wui-image")], u));
    },
    29343: (t, e) => {
            ...
            let w = (function (t, e, r) {
                ...
                return (function (t, e, r) {
                  let o,
                    ...
                    s = a - h.getTotalCodewordsCount(e, r),
                    l = h.getBlocksCount(e, r),
                    u = a % l,
                    f = l - u,
                    d = Math.floor(a / l),
                    g = Math.floor(s / l),
                  ...
                  for (o = 0; o < C; o++)
                    for (i = 0; i < l; i++)
                      o < E[i].length && (A[M++] = E[i][o]);
                  for (o = 0; o < m; o++)
                    for (i = 0; i < l; i++) A[M++] = v[i][o];
                  return A;
                })(o, t, e);
              })(e, r, d),
    ...
    66444: (t, e, r) => {
      ...
      (o.getBitsLength = function (t) {
        ...
        (o.prototype.write = function (t) {
          ...
          o > 0 &&
            ((n = parseInt(this.data.substr(e), 10)), t.put(n, 3 * o + 1));
        }),
        (t.exports = o);
    },
    69184: (t, e, r) => {
          ...
          let o = (function (t, e) {
              ...
              for (let a = 0; a < t.length; a++) {
                ...
                for (let t = 0; t < s.length; t++) {
                  let u = s[t],
                    h = "" + a + t;
                  l.push(h), (r[h] = { node: u, lastCount: 0 }), (o[h] = {});
